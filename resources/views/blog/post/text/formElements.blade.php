...
<div class="input-group my-3">
  ...
  <input name="metaDescription"
         ...
         placeholder="{{ (isset($item->metaDescription)) ? $item->metaDescription : 'metaDescription' }}"
...
<div class="input-group my-3">
  ...
  <input name="metaKeywords"
         ...
         placeholder="{{ (isset($item->metaKeywords)) ? $item->metaKeywords : 'metaKeywords' }}"
...
<div class="input-group my-3">
  ...
  <input name="preview"
         ...
         placeholder="{{ (isset($item->preview)) ? $item->preview : 'preview' }}"
         value="{{ $item->preview ?? '' }}"
...
<div class="input-group my-3">
  ...
  <input name="title"
         ...
         placeholder="{{ (isset($item->title)) ? $item->title : 'title' }}"
         value="{{ $item->title ?? '' }}"
...
<div class="input-group my-3">
  ...
  <input name="description"
         ...
         placeholder="{{ (isset($item->description)) ? $item->description : 'description' }}"
...
<div class="input-group my-3">
  ...
  <input name="after"
         ...
         placeholder="{{ (isset($item->after)) ? $item->after : 'after' }}"
         value="{{ $item->after ?? '' }}"
